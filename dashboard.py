...
# DATASETS
Data_Aggregated_Transaction_df= pd.read_csv(r'data/Data_Aggregated_Transaction_Table.xlsx')
Data_Aggregated_User_Summary_df= pd.read_csv(r'data/Data_Aggregated_User_Summary_Table.xlsx')
Data_Aggregated_User_df= pd.read_csv(r'data/Data_Aggregated_User_Table.xlsx')
Scatter_Geo_Dataset =  pd.read_csv(r'data/Data_Map_Districts_Longitude_Latitude.xlsx')
Coropleth_Dataset =  pd.read_csv(r'data/Data_Map_IndiaStates_TU.xlsx')
Data_Map_Transaction_df = pd.read_csv(r'data/Data_Map_Transaction_Table.xlsx')
Data_Map_User_Table= pd.read_csv(r'data/Data_Map_User_Table.xlsx')
Indian_States= pd.read_csv(r'data/Longitude_Latitude_State_Table.xlsx')
